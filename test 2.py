...
#%%
'''
Finding ids of cars in lane x frame y
...
#        peaks_groups.append([])
    ...
    plt.title('Anomaly detection demonstration for 1 frame in lane '+lanes[j], fontsize= 20)
    plt.ylim(ylim_min,ylim_max)
    plt.savefig('Figures/Dataset_'+str(switch+1)+'/Frame_1_lane_'+lanes[j]+'.png',bbox_inches='tight')
    plt.show()
    #
